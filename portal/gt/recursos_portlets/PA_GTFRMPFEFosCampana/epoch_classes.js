...
function Epoch(name,mode,targetelement,multiselect) {
	...
	*/
	function calConfig() {
		...
		self.maxDate = new Date(2036,11,31);
	...
	*/
	function setLang() {
		...
		self.maxrange_caption = 'Este es el rango m�ximo';
...
Date.prototype.dateFormat = function(format)
{
	...
	var DAY_NAMES = new Array('Domingo','Lunes','Martes','Mi�rcoles','Jueves','Viernes','S�bado','Dom','Lun','Mar','Mie','Jue','Vie','Sab');
	var result="";
	var i_format=0;
	var c="";
	var token="";
